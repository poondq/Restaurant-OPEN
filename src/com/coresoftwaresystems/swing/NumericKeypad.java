...
public class NumericKeypad extends javax.swing.JComponent {
	...
	public synchronized void removeKeypadEventListener(
	...
	protected synchronized void fireKeypadEvent(int eventId) {
		...
		for (int i = listeners.length - 2; i >= 0; i -= 2) {
			if (listeners[i] == KeypadEventListener.class) {
				...
				((KeypadEventListener) listeners[i + 1])
						.receiveKeypadEvent(keypadEvent);
			}
		}
	}
	...
	private void initComponents() {
		...
		org.jdesktop.layout.GroupLayout displayPanelLayout = new org.jdesktop.layout.GroupLayout(
				displayPanel);
		displayPanel.setLayout(displayPanelLayout);
		displayPanelLayout.setHorizontalGroup(displayPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(org.jdesktop.layout.GroupLayout.TRAILING, txtInput,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 368,
						Short.MAX_VALUE));
		displayPanelLayout.setVerticalGroup(displayPanelLayout
				.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(txtInput, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						30, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE));
		...
		posButton10
				.setIcon(com.floreantpos.IconFactory.getIcon("clear_32.png"));
		...
		layout.setHorizontalGroup(layout
				...
				.add(displayPanel,
						...
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE)
				.add(keypadPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
						368, Short.MAX_VALUE)
				.add(actionpadPanel,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 368,
						Short.MAX_VALUE));
