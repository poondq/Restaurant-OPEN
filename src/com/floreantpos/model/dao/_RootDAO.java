...
*/
	...
	public static void initialize() {
		...
		configuration = configuration.setProperty("hibernate.connection.driver_class", ApplicationConfig.getDatabaseDriver());
		configuration = configuration.setProperty("hibernate.connection.url", ApplicationConfig.getConnectionURL());
		System.out.println(ApplicationConfig.getConnectionURL());
