...
posButton4.addActionListener(new java.awt.event.ActionListener() {
public void actionPerformed(java.awt.event.ActionEvent evt) {
posButton4ActionPerformed(evt);
}
});
...
//cbUserType.setModel(javax.swing.DefaultComboBoxModel@197f53a);
...
.addContainerGap()
.add(jLabel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 357, Short.MAX_VALUE)
.addContainerGap())
.add(org.jdesktop.layout.GroupLayout.TRAILING, tfPassword, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
.add(tfUserId, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
.add(jPanel2Layout.createSequentialGroup()
.add(jLabel4)
.add(18, 18, 18)
.add(cbUserType, 0, 241, Short.MAX_VALUE))
);
...
add(jPanel1, gridBagConstraints);
	...
	private void posButton4ActionPerformed(java.awt.event.ActionEvent evt) {
	...
	public void doLogin() {
		try {
			...
			if (!user.getPassword().equalsIgnoreCase(
					PasswordHasher.hashPassword(newPass))) {
